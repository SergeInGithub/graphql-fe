  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        <div className="px-6 py-4 whitespace-nowrap text-white text-sm font-medium">
          <button
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider-wider"
                  >
                    Description
                  </th>
